...
export class RegistroComponent implements OnInit {
  ...
  //private _listPaisesFilter: string = '';
  //get listPaisesFilter(): string {
  //  return this._listPaisesFilter;
  //}
  //set listPaisesFilter(value: string) {
  //  this._listPaisesFilter = value;
  //  //this.filterPaises(value.toLowerCase);
  //}
